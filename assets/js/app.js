// create an array of shows - in this case, 90's and 2000's Rock/Alternative Bands
var shows = ["Green Day", "Blink 182", "Fall Out Boy", "My Chemical Romance", "Audioslave", "Godsmack", "Tool", "AFI", "Alice in Chains", "Rage Against the Machine", "Sublime", "Nirvana", "New Found Glory", "Radiohead", "Deftones"];
...
$("#addShow").on("click", function(){
	...
	shows.push(show);
	// the makeButtons function is called, which makes buttons for all bands plus the user band
	makeButtons();
